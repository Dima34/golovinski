...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ScrollSmoother_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ScrollSmoother.js */ "./src/js/ScrollSmoother.js");
...
window.addEventListener('DOMContentLoaded', event => {
  ...
  gsap.registerPlugin(GSDevTools, ScrollTrigger, _ScrollSmoother_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
  _ScrollSmoother_js__WEBPACK_IMPORTED_MODULE_0__["default"].create({
...
const currentFrame = index => `./img/plateSequence/0${index.toString()}.jpg`;
const preloadImages = () => {
...
function updateImageByValue(value) {
  const frameIndex = Math.min(frameCount - 1, Math.ceil((value + 1) / 2 * frameCount));
...
preloadImages();
if (!isMobile()) {
  function initRunline(runlineSelector) {
    let numberOfDuplicates = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 13;
